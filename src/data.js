...
import landingpage from './assets/nextjs-landing-page1.png';
import landingpagetwo from './assets/nextjs-landing-page2.png';
...
export const projects = [
	{
		...
		desc: 'Implemented using Next.js and Tailwind CSS.',
		technicalDesc: '',
		updateDesc:
			"Landing page is live. The drafts are also provided here. Check out the GitHub repository for the code or click on 'Demo' to view the application online.",
		note: '',
		tech: ['Next.js', 'Tailwind CSS', 'JavaScript (ES6)', 'HTML5'],
	...
	},
	{
		...
		title: 'E Blood Bank',
		desc: 'A React.js application that allows users to register/login and donate blood. They can also view the list of donors and filter records based on blood type.',
		technicalDesc: '',
		updateDesc: 'Check out the GitHub repository for the code.',
		note: '',
	...
	},
	{
		...
		title: 'Done With It',
		desc: 'Done With It is a React Native application for selling the stuff you do not need anymore.',
		technicalDesc: '',
		updateDesc: 'Check out the GitHub repository for the code.',
		note: '',
		tech: ['React Native', 'CSS3', 'JavaScript (ES6)', 'Formik', 'Yup'],
